...
def linux_distribution(full_distribution_name=True):
    ...
    * ``id_name``:  If *full_distribution_name* is false, the report of
      :func:`distro.id`. Otherwise, the report of :func:`distro.name`.

    * ``version``:  The report of :func:`distro.version`.

    * ``codename``:  The report of :func:`distro.codename`.
...
def version_parts(best=False):
    ...
    * ``major``:  The report of :func:`distro.major_version`.

    * ``minor``:  The report of :func:`distro.minor_version`.

    * ``build_number``:  The report of :func:`distro.build_number`.
...
def info(pretty=False, best=False):
    ...
    * ``id``:  The report of :func:`distro.id`.

    * ``version``:  The report of :func:`distro.version`.

    * ``version_parts -> major``:  The report of :func:`distro.major_version`.

    * ``version_parts -> minor``:  The report of :func:`distro.minor_version`.

    * ``version_parts -> build_number``:  The report of
      :func:`distro.build_number`.

    * ``like``:  The report of :func:`distro.like`.
...
class LinuxDistribution(object):
    ...
    def __init__(self,
        ...
        * ``include_lsb`` (bool): The report of the ``include_lsb`` parameter.
